...
import io.github.squat_team.performance.peropteryx.start.HeadlessPerOpteryxConstantsImrpoved;

public class ExtensionRegistryImproved implements IExtensionRegistry {
	IExtensionPoint lqnExtensionPoint = new ExtensionPointImproved();
	...
	public IConfigurationElement[] getConfigurationElementsFor(String extensionPointId) {
		if(extensionPointId.equals(HeadlessPerOpteryxConstantsImrpoved.IRESTULSTHANDLER_ID)){
			IConfigurationElement[] resultHandlers = new ResultHandlerConfigurationElementImrpoved[1];
			resultHandlers[0] = new ResultHandlerConfigurationElementImrpoved();

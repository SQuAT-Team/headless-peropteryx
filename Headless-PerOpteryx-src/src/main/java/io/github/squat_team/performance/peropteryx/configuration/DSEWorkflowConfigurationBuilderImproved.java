...
import io.github.squat_team.performance.peropteryx.environment.Pcm2LqnLaunchConfigurationImrpoved;

public class DSEWorkflowConfigurationBuilderImproved{
	
	private ConfigurationImprovedImproved config;
	
	public void init(ConfigurationImprovedImproved config){
		this.config = config;
	}
	...
	private ILaunchConfiguration deriveLaunchConfiguration(){
		...
		return new Pcm2LqnLaunchConfigurationImrpoved(attr);
	}

...
public class MyPCMResourceSetPartitionImrpoved extends PCMResourceSetPartition{

	ResourceSet rs = new MyResourceSetImplImrpoved();
	...
	public MyPCMResourceSetPartitionImrpoved(){
		super();
		super.rs = this.rs;
	}

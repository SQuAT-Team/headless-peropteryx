...
public class MyResourceSetImplImrpoved extends ResourceSetImpl {

	 /**
	   * The contained resources.
	   * @see #getResources
	   */
	  protected volatile EList<Resource> resources;
	   ...
	   */
	  public MyResourceSetImplImrpoved()
	  {
	    super();
	  }
	    ...
	    if (resourceFactoryRegistry == null)
	    {
	      resourceFactoryRegistry =
	        new ResourceFactoryRegistryImpl()
	        {
	          ...
	          {
	            return MyResourceSetImplImrpoved.this.getURIConverter();
	          }

	          @Override
	          protected Map<?, ?> getContentDescriptionOptions()
	          {
	            return new OptionsMap(ContentHandler.OPTION_REQUESTED_PROPERTIES, CONTENT_TYPE_REQUESTED_PROPERTIES, getLoadOptions());
	          }
	        };
	    }
	  ...
	  protected class ResourcesEList<E extends Object & Resource> extends NotifyingInternalEListImpl<E> implements InternalEList<E>
	  {
	    ...
	    {
	      return MyResourceSetImplImrpoved.this.eNotificationRequired();
	    }
	    ...
	    {
	      return MyResourceSetImplImrpoved.this;
	    }
	    ...
	    protected NotificationChain inverseAdd(E object, NotificationChain notifications)
	    {
	      ...
	      return resource.basicSetResourceSet(MyResourceSetImplImrpoved.this, notifications);
	    }
	    ...
	    {
	      return size <= 4 ? super.contains(object) : object instanceof Resource && ((Resource)object).getResourceSet() == MyResourceSetImplImrpoved.this;
	    }
	  }
	  ...
	  public static abstract class ResourceLocator
	  {
	     ...
	     */
	    protected final MyResourceSetImplImrpoved resourceSet;
	     ...
	     */
	    public ResourceLocator(MyResourceSetImplImrpoved resourceSet)
	    {
	  ...
	  public static class MappedResourceLocator extends ResourceLocator
	  {
	     ...
	     */
	    public MappedResourceLocator(MyResourceSetImplImrpoved resourceSet)
	    {
	      super(resourceSet);

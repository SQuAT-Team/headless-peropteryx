...
import io.github.squat_team.performance.peropteryx.overwrite.reader.MyQMLDimensionReaderImrpoved;

public abstract class MyAbstractPerformanceAttributeDeclarationImrpoved implements IAnalysisQualityAttributeDeclaration{
	...
	public MyAbstractPerformanceAttributeDeclarationImrpoved() {
		super();
		MyQMLDimensionReaderImrpoved reader = new MyQMLDimensionReaderImrpoved();

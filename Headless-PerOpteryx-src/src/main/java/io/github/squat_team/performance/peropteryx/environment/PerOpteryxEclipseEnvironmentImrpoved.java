...
import io.github.squat_team.performance.peropteryx.registry.RegistryProviderImproved;

public enum PerOpteryxEclipseEnvironmentImrpoved {
	INSTANCE;
    ...
    PerOpteryxEclipseEnvironmentImrpoved() {
    }
	...
	private void initializeFakeRegistry() {
		RegistryProviderImproved regprovider = new RegistryProviderImproved();
		try {

 ...
 */
public class Pcm2LqnLaunchConfigurationImrpoved implements ILaunchConfiguration {

	private Map<String, Object> attr = new HashMap<>();

	private Logger log = Logger.getLogger(Pcm2LqnLaunchConfigurationImrpoved.class.getName());
	
	public Pcm2LqnLaunchConfigurationImrpoved(Map<String, Object> attr) {
	...
	public ILaunchConfigurationWorkingCopy getWorkingCopy() throws CoreException {
		return new LaunchConfigurationWorkingCopyImrpoved(this);
	}

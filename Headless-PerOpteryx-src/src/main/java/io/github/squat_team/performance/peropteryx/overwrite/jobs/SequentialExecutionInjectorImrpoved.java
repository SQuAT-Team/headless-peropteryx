 ...
 */
public class SequentialExecutionInjectorImrpoved {
    private static final Logger log = Logger.getLogger(SequentialExecutionInjectorImrpoved.class.getName());
	...
	public SequentialExecutionInjectorImrpoved(DSEWorkflowConfiguration dseConfig, List<IAnalysis> evaluators,

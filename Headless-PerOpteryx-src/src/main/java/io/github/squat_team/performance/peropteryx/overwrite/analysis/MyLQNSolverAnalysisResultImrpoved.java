 ...
 *
 */
public class MyLQNSolverAnalysisResultImrpoved extends MyLQNResultImrpoved implements IStatisticAnalysisResult {
	

	public MyLQNSolverAnalysisResultImrpoved(LqnModelType model, PCMInstance pcm, 

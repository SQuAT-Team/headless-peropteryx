...
public class MyLQNSolverAnalysisImproved extends MyAbstractLQNAnalysisImproved {
...
//			 throw e;
	...
	protected ILQNResult retrieveResult(PCMInstance pcm,
		...
		ILQNResult result;
		if (hasConverged){
			result = new MyLQNSolverAnalysisResultImrpoved(model, pcm, criterion, this.criterionToAspect, (MyLQNQualityAttributeDeclarationImrpoved)this.qualityAttribute);
		} else {

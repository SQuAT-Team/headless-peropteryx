...
public abstract class MyLQNResultImrpoved extends AbstractPerformanceAnalysisResult implements ILQNResult{
	...
	private MyLQNQualityAttributeDeclarationImrpoved qualityAttributeInfo;

	

	public MyLQNResultImrpoved(PCMInstance pcm, LqnModelType model,
			Criterion criterion, Map<Criterion, EvaluationAspectWithContext> objectiveToAspect,
			MyLQNQualityAttributeDeclarationImrpoved qualityAttributeInfo) throws AnalysisFailedException {
		super(pcm);
		try{

 ...
 *
 */
public class MyQMLDimensionReaderImrpoved {
	...
	public Dimension getDimension(String dimensionPath) {
		...
		resourceSet.setURIConverter(PalladioEclipseEnvironmentImrpoved.INSTANCE.getUriConverter());
		...
		for (EObject eObject : resource.getContents()) {
			...
			if (diagnostic.getSeverity() != Diagnostic.OK) {
				new MyQMLDeclarationsReaderImrpoved().printDiagnostic(diagnostic, "");

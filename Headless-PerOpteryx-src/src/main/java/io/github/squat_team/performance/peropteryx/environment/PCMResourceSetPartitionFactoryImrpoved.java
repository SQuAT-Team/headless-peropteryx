 ...
 */
public interface PCMResourceSetPartitionFactoryImrpoved {
     ...
     */
    class DefaultFactory implements PCMResourceSetPartitionFactoryImrpoved {
        ...
        public PCMResourceSetPartition create() {
            ...
            rsp.getResourceSet().setURIConverter(PalladioEclipseEnvironmentImrpoved.INSTANCE.getUriConverter());

...
public class LaunchConfigurationWorkingCopyImrpoved implements ILaunchConfigurationWorkingCopy{
	Pcm2LqnLaunchConfigurationImrpoved parentConfiguration;
	Map<String, Object> tempMap = new HashMap<String, Object>();
	
	public LaunchConfigurationWorkingCopyImrpoved(Pcm2LqnLaunchConfigurationImrpoved parentConfiguration) {

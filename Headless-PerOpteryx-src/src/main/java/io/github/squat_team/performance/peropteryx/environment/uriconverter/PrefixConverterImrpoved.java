...
/**
 * If the URI to be converted matches the given prefix, the prefix is replaced by the given replacement.
 */
public class PrefixConverterImrpoved implements URIConverterInterceptorImrpoved {

    private String prefix;
    private String replacement;

    public PrefixConverterImrpoved(String prefix, String replacement) {
        this.prefix = prefix;

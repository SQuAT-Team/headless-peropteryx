 ...
 */
public class MyLoadPCMModelsIntoBlackboardJobImrpoved extends SequentialBlackboardInteractingJob<MDSDBlackboard>
	 ...
	 */
	public MyLoadPCMModelsIntoBlackboardJobImrpoved(final AbstractPCMWorkflowRunConfiguration config) {
		super(false);

...
public abstract class MyAbstractAnalysisImrpoved implements IAnalysis {
	...
	public MyAbstractAnalysisImrpoved(IAnalysisQualityAttributeDeclaration qualityAttribute) {
		super();
